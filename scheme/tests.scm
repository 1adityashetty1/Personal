...
;;; **********************************
;;; *** Add more of your own here! THESE WERE IN AN ORDER, BUT THEY GOT JUMBLED UP***
;;; **********************************

(define ooga (mu (x) (display x)(+ x x y)))
(define chaka (lambda (x y) (ooga 3)))
(chaka 2 3)
; expect 39

(define (what in the world) (+ the (- in (/ world 10))))
(what 7 8 9)
; expect 14.1
